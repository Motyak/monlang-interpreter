...
static value_t bitwise_xor_Byte(Byte firstArgValue, const std::vector<FlattenArg>& args);
static value_t bitwise_xor_Int(Int firstArgValue, const std::vector<FlattenArg>& args);

const value_t builtin::op::bitwise_xor __attribute__((init_priority(3000))) = new prim_value_t{prim_value_t::Lambda{
    IntConst::TWO,
    [](const std::vector<FlattenArg>& args) -> value_t {
        ...
        return std::visit(overload{
            [&otherArgs](Byte byte) -> value_t {return bitwise_xor_Byte(byte, otherArgs);},
            [&otherArgs](Int int_) -> value_t {return bitwise_xor_Int(int_, otherArgs);},

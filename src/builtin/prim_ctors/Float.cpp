...
static prim_value_t::Float to_float(const prim_value_t& primVal) {
    return std::visit(overload{
        ...
        [](prim_value_t::Bool) -> prim_value_t::Float {SHOULD_NOT_HAPPEN();},
        [](const prim_value_t::Str&) -> prim_value_t::Float {SHOULD_NOT_HAPPEN();},
        [](const prim_value_t::List&) -> prim_value_t::Float {SHOULD_NOT_HAPPEN();},
        [](const prim_value_t::Map&) -> prim_value_t::Float {SHOULD_NOT_HAPPEN();},
        [](const prim_value_t::Lambda&) -> prim_value_t::Float {SHOULD_NOT_HAPPEN();},
    }, primVal.variant);
}

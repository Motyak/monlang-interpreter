...
static prim_value_t::Int to_int(const prim_value_t& primVal) {
    return std::visit(overload{
        ...
        [](const prim_value_t::Str&) -> prim_value_t::Int {SHOULD_NOT_HAPPEN();},
        [](const prim_value_t::List&) -> prim_value_t::Int {SHOULD_NOT_HAPPEN();},
        [](const prim_value_t::Map&) -> prim_value_t::Int {SHOULD_NOT_HAPPEN();},
        [](const prim_value_t::Lambda&) -> prim_value_t::Int {SHOULD_NOT_HAPPEN();},
    }, primVal.variant);
}

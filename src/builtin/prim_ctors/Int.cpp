...
value_t IntConst::ZERO(){return new prim_value_t{prim_value_t::Int(0)};}
value_t IntConst::ONE(){return new prim_value_t{prim_value_t::Int(1)};}
value_t IntConst::TWO(){return new prim_value_t{prim_value_t::Int(2)};}

...
namespace prim_ctor {
    ...
    prim_value_t::Bool Bool_(value_t);
    prim_value_t::Byte Byte_(value_t);
    prim_value_t::Int Int_(value_t);
    prim_value_t::Float Float_(value_t);
    prim_value_t::Str Str_(const value_t&);

    // this one accepts any container (Str, List, Map)..
    // ,.. not just List
    prim_value_t::List List_(value_t container);

    prim_value_t::Map Map_(value_t);
    prim_value_t::Lambda Lambda_(value_t);
